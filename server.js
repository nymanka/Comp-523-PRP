...
// const jwtSecretKey = "supercomplex";
// const app = express();
// app.use(expressJwt({ secret: jwtSecretKey, algorithms: ['HS256'] }).unless({ path: ['/signin', '/register'] }));
...
//     // Since express-jwt middleware is used, req.user should already have the userId from the token
